...
async function enqueuePost({ reelSlug, videoUrl, caption, scheduledAt, platform = 'instagram', contentTrack = 'main', mediaType = 'video' }) {
  await ensureSchema();
  const { rows } = await getPool().query(
    `INSERT INTO scheduled_posts (reel_slug, video_url, caption, scheduled_at, platform, content_track, media_type) VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING id`,
    [reelSlug, videoUrl, caption, scheduledAt, platform, contentTrack, mediaType]
  );
  return rows[0].id;
}
